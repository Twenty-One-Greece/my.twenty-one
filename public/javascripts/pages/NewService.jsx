...
export default class NewService extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { title: '', description: '',  type: '', product: '', category: [], price: '',
            ...
            includes: '', notIncludes: '', periods: {}, tourLanguage: [],
            from: '', to: '', startDate: null, endDate: null, langitude: '', longitude: '', 
            destination: '', destinationOtagID: '', providerName: '', departureDays: [],
    ...
    handleUpdateInput(value, result) {
        ...
        if(result.length) this.setState({ providerName: value })
    }
    ...
    render() {
        ...
        <div className='row'>
            ...
            <h3>New Service</h3>
                ...
                <MuiThemeProvider>
                <AutoComplete fullWidth={true} onNewRequest={(e) => this.selectMatch(e)} filter={AutoComplete.fuzzyFilter} floatingLabelText="Match with Provider" dataSource={this.state.dataSource} onUpdateInput={this.handleUpdateInput}  dataSourceConfig={{text: 'name', value: 'otagDestinationCode',}}/>
                </MuiThemeProvider>
            ...
            <div className="col-md-offset-1 col-md-4">
                ...
                <SelectField className="select" multiple={true} fullWidth={true} floatingLabelText="Tour Language" value={this.state.tourLanguage} onChange={(event, index, values) => this.handleMultipleSelectChange('tourLanguage', values)} >
                    ...
                    <MenuItem checked={this.state.tourLanguage && this.state.tourLanguage.includes('Italian')} value={'Italian'} primaryText="Italian" />
                    <MenuItem checked={this.state.tourLanguage && this.state.tourLanguage.includes('French')} value={'French'} primaryText="French" />
                </SelectField>
                </MuiThemeProvider>
                ...
                <SelectField className="select" fullWidth={true} floatingLabelText="Duration" value={this.state.duration} onChange={this.handleChange("duration")}>
                    ...
                    <MenuItem value={'15 day / 14 nights'} primaryText="15 day / 14 nights" />
                </SelectField>
                </MuiThemeProvider>
