...
export default class NewDestination extends React.Component {
    
    constructor(props) {
        super(props)
        this.state = { title: '', description: '', thingsToDo: '', include: true, featured: false, images: [], userID: localStorage.getItem('_id') }
    ...
    handleSubmit(e) {
        e.preventDefault()
        axios.post(URL_FOR_DESTINATIONS + '/new', this.state)
